  ...
  return (
    <div className="min-h-dvh w-full flex items-center justify-center px-4 bg-[var(--color-bg-light)] dark:bg-[var(--color-bg-dark)]">
      <div className="max-w-md w-full surface border border-hairline rounded-2xl p-6 text-center">
        ...
        <h1 className="font-display text-lg font-semibold mb-2">Supabase configuration is invalid</h1>
        <p className="text-sm text-muted mb-4">
          This build needs a valid <code className="num text-xs surface-2 px-1 py-0.5 rounded">VITE_SUPABASE_URL</code> and{' '}
        ...
        <div className="text-left text-sm surface-2 rounded-lg p-3 space-y-1.5">
          ...
          <p className="text-muted">
            ...
            <code className="num text-xs">.env.local</code> and fill in your Supabase project's URL and anon key. Do not use the placeholder URL.
          </p>
          <p className="text-muted">
