...
export function useBalanceAsOf(accountId: string | undefined, beforeDate: string | undefined) {
  return useQuery({
    queryKey: ['balance-as-of', accountId ?? 'all', beforeDate],
    queryFn: () => fetchBalanceAsOf(accountId, beforeDate as string),
    enabled: !!beforeDate,
  })
}
