...
// SUPABASE_SERVICE_ROLE_KEY. This mirrors the same helper in
// supabase/functions/parse-statement/lib/password-crypto.ts so both functions
// can decrypt the same values.
